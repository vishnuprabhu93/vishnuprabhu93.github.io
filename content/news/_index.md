...
<!-- This page lists news entries. Each entry is either:
     ...
     ordered newest first. Plain-text-only entries (no linked page) can be added directly
     in a "briefs" section of this file or as minimal pages with no body content — decide
     which pattern fits the chosen theme when building layouts. -->
